...
public class FastCGIHandler {
    ...
    /**
     * socket to cgi (add by zhuguangwen 2014-5-20 23:09)
     */
    private Socket fcgiSocket = null;
    
    /**
     * send fcgi request
     * @param request  the request adapter (add by zhuguangwen 2014-5-20 23:09)
     * @throws IOException
     */
    public void sendRequest(RequestAdapter request) throws IOException{
    	
    	System.out.println("send fcgi request");
    	
        fcgiSocket = connectionFactory.getConnection();
...
//        }
    ...
    /**
     * get fcgi response
     * @param response   the response adapter  (add by zhuguangwen 2014-5-20 23:09)
     * @throws IOException
     */
    public void getResponse(ResponseAdapter response) throws IOException{
    	
    	System.out.println("get fcgi response");
